...
[![Version](https://img.shields.io/badge/version-2.18.34-2563EB.svg?style=flat-square)](VERSION)
...
**v2.18.34 更新：** 新增 `/dbs-video-extract`，可提取短视频数据与语音文字稿；缺少外部服务凭证时，会引导购买并安全配置。
