...
[![Version](https://img.shields.io/badge/version-2.18.16-2563EB.svg?style=flat-square)](VERSION)
...
**v2.18.16 更新：** 30 个正式 Skill 的 description 从 10,635 个字符压缩到 1,907 个字符，保留能力、使用场景和关键匹配词；新增 Skill 元数据发布门禁，校验官方长度规范、项目上下文预算和 beta 隐藏标记。
