...
[![Version](https://img.shields.io/badge/version-2.18.29-2563EB.svg?style=flat-square)](VERSION)
...
**v2.18.29 更新：** `/dbs-spread` 与 `/dbs-resonate` 会按内容选择匹配的传播学与社会心理学理论，并标明文本证据、解释边界和置信度；沉默的螺旋、认知失调与两级传播只在满足适用条件时调用。
