...
[![Version](https://img.shields.io/badge/version-2.18.27-2563EB.svg?style=flat-square)](VERSION)
...
**v2.18.27 更新：** 外部 Skill 的目录名与声明名不一致时，`/dbs-install-skill` 也会按正式名称安装并清理旧别名。
