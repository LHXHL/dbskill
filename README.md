...
[![Version](https://img.shields.io/badge/version-2.18.21-2563EB.svg?style=flat-square)](VERSION)
...
**v2.18.21 更新：** 多端 Skill 桥接改为自动路由。支持通用目录的 Agent 共用一份入口，其他已安装 Agent 自动补充专属软链，并清理重复和失效链接，用户无需选择桥接模式。
