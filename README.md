...
[![Version](https://img.shields.io/badge/version-2.18.28-2563EB.svg?style=flat-square)](VERSION)
...
**v2.18.28 更新：** `/dbs-standard-answer` 会先根据现有材料回答，只在关键事实影响结论时联网；简单问题不再自动展开理论地图和历史案例。
